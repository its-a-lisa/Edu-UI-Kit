...
import sty from "./PlasmicContactIcons.module.css"; // plasmic-import: U7fipxDrwbBk/css

import FaPhoneSolidsvgIcon from "./icons/PlasmicIcon__FaPhoneSolidsvg"; // plasmic-import: 5phALsWc362I/icon
import FaMessageSolidsvgIcon from "./icons/PlasmicIcon__FaMessageSolidsvg"; // plasmic-import: gE_Av3BOFS5M/icon
import FaEmailSolidsvgIcon from "./icons/PlasmicIcon__FaEmailSolidsvg"; // plasmic-import: jKZoqh-aMBEW/icon
import FaCalendarSolidsvgIcon from "./icons/PlasmicIcon__FaCalendarSolidsvg"; // plasmic-import: T48BikaXkRec/icon
      ...
      >
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <FaPhoneSolidsvgIcon
                className={classNames(projectcss.all, sty.svg___1FBf)}
                role={"img"}
              />
            ),
          ...
          {renderPlasmicSlot({
            defaultContents: (
              <FaMessageSolidsvgIcon
                className={classNames(projectcss.all, sty.svg__gTdJy)}
                role={"img"}
              />
            ),
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <FaEmailSolidsvgIcon
                className={classNames(projectcss.all, sty.svg__qOmD)}
                role={"img"}
              />
            ),
          ...
          {renderPlasmicSlot({
            defaultContents: (
              <FaCalendarSolidsvgIcon
                className={classNames(projectcss.all, sty.svg__wn6Mm)}
                role={"img"}
              />
            ),
