...
import sty from "./PlasmicListItem.module.css"; // plasmic-import: NLSlIBWCa0Ns/css

import FaBarssvgIcon from "./icons/PlasmicIcon__FaBarssvg"; // plasmic-import: i1GG_jqfzp-L/icon
      ...
      >
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <FaBarssvgIcon
                className={classNames(projectcss.all, sty.svg__slj0Y)}
                role={"img"}
              />
            ),
