...
import sty from "./PlasmicAction.module.css"; // plasmic-import: ES7f8Dx45R8j/css

import CollapseIcon from "../icon/icons/PlasmicIcon__Collapse"; // plasmic-import: x25yhcuuTvTS/icon
import ViewIcon from "../icon/icons/PlasmicIcon__View"; // plasmic-import: vh9oX_MuVy4l/icon
import EditIcon from "../icon/icons/PlasmicIcon__Edit"; // plasmic-import: 7LbOdkz1y0CD/icon
import SaveIcon from "../icon/icons/PlasmicIcon__Save"; // plasmic-import: 6GTYFzfKR-ur/icon
import CloseIcon from "../icon/icons/PlasmicIcon__Close"; // plasmic-import: kPPmYLazttRO/icon
import LeftArrowsvgIcon from "../icon/icons/PlasmicIcon__LeftArrowsvg"; // plasmic-import: J2ohuOWoSeX_/icon
