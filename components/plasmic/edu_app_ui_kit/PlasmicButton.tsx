...
import sty from "./PlasmicButton.module.css"; // plasmic-import: deRzoMNf1UtH/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <FaChecksvgIcon
              className={classNames(projectcss.all, sty.svg__bMsyD)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <FaArrowRightsvgIcon
              className={classNames(projectcss.all, sty.svg__qIzr2)}
              role={"img"}
            />
          ),
