...
import sty from "./PlasmicShareIcons.module.css"; // plasmic-import: J2lAwkWT-bIT/css

import FaShareSquaresvgIcon from "./icons/PlasmicIcon__FaShareSquaresvg"; // plasmic-import: v3VUhrWUQ3Ov/icon
import FaBookmarkSolidsvgIcon from "./icons/PlasmicIcon__FaBookmarkSolidsvg"; // plasmic-import: XtrOaOQaLt4c/icon
          ...
          {renderPlasmicSlot({
            defaultContents: (
              <FaShareSquaresvgIcon
                className={classNames(projectcss.all, sty.svg__nDat8)}
                role={"img"}
              />
            ),
          ...
          {renderPlasmicSlot({
            defaultContents: (
              <FaBookmarkSolidsvgIcon
                className={classNames(projectcss.all, sty.svg__p2Ps5)}
                role={"img"}
              />
            ),
