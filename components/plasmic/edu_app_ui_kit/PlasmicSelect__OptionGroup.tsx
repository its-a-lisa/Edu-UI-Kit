...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: aX8OzBeR3b5R/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: i-duw3PRJkpa/render
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__dDrY)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__gmafQ)}
              />
            </React.Fragment>
          ),
          value: args.children,
