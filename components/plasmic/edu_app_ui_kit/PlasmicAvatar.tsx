...
import sty from "./PlasmicAvatar.module.css"; // plasmic-import: tVPVe_AvQVJ9/css

import FaUsersvgIcon from "./icons/PlasmicIcon__FaUsersvg"; // plasmic-import: lrDhDbbPjbEp/icon
      ...
      >
        {(
          ...
          ? renderPlasmicSlot({
              defaultContents: (
                <FaUsersvgIcon
                  className={classNames(projectcss.all, sty.svg__uwUzp)}
                  role={"img"}
                />
              ),
        ...
        {(
          ...
          ? renderPlasmicSlot({
              defaultContents: (
                <PlasmicImg__
                  alt={""}
                  className={classNames(sty.img__lVrrC)}
                  displayHeight={"auto"}
